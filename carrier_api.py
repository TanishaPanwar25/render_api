...
# ─── ROUTE 2: Summary Stats ── pehle fixed routes ────────────────────────────
...
# ─── ROUTE 3: High Delay Alert ── fixed route ────────────────────────────────
...
# ─── ROUTE 4: Get by Hub ── fixed route ──────────────────────────────────────
...
# ─── ROUTE 5: Get by Manifest ID ── fixed route ──────────────────────────────
...
# ─── ROUTE 6: Get All Records ── paginated ───────────────────────────────────
...
# ─── ROUTE 7: Get by Telemetry ID ── dynamic route LAST ─────────────────────
